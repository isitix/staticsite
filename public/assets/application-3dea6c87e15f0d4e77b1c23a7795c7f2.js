...
(function ($) {
    ...
    skel.init({
        reset: 'full',
        breakpoints: {
            'global': {range: '*', href: '/assets/style-e276ae1aba7785a01f73a39e0e0016d0.css'},
            'desktop': {range: '737-', href: '/assets/style-desktop-4ff06361fa8bd592f56fca670886c7e4.css', containers: 1200, grid: {gutters: 50}},
            '1000px': {
                range: '737-1200',
                href: '/assets/style-1000px-f66bc77311968cdf61c0ce7c407fc7bb.css',
                containers: 960,
                grid: {gutters: 30},
                viewport: {width: 1080}
            },
            'mobile': {
                range: '-736',
                href: '/assets/style-mobile-dd7211c9d89c4d7ce3c8e8bab7578784.css',
                containers: '100%!',
